...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        ...
        [
	    [PR['PR_TYPE'], /^(?:real|int|vector|row_vector|matrix|simplex|corr_matrix|cov_matrix)\b/],
            [PR['PR_COMMENT'],     /^(?:(\/\/|#)[^\r\n]*|\/\*[\s\S]*?\*\/)/],
	    [PR['PR_KEYWORD'],     /^(?:for|in|lp__|data|data|(transformed\s+)?(parameters|data)|model|quantities)\b/, null],
	    // numbers
